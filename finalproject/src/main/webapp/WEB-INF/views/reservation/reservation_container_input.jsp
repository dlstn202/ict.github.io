      ...
      <div class="contents-inner">
        <div class="contents-container container-md">
          <div class="contents-top">
            ...
            <button class="btnset btnset-round btnset-line btnset-black" disabled="">55,000KRW</button>
          </div>
          <div class="contents-bottom">
            <span>글램핑 정보</span>
            <strong>템하, 반나절 글램핑</strong>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="contents-inner">
        <div class="contents-container container-md">
          <div class="contents-top">
            ...
            <div class="contents-group">
              ...
              <div class="form-wrap">
                ...
                <div class="inputset inputset-round">
                  <textarea class="inputset-textarea" required=""></textarea>
          ...
          <div class="contents-confirm">
            <a href="javascript:void(0);" class="btnset btnset-round">예약완료</a>
          </div>
        </div>
      </div>
    </div>
