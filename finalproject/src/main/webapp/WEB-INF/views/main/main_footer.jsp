...
<body>
  ...
  <footer class="glamping-N3" data-bid="NgltwpHQWu">
    <div class="footer-container">
      <img class="footer-backimg img-pc" src="${pageContext.request.contextPath}/assets/images/img_footer.png" alt="PC 푸터 비주얼">
      <img class="footer-backimg img-mobile" src="${pageContext.request.contextPath}/assets/images/img_footer_mobile.png" alt="모바일 푸터 비주얼">
