    ...
    <div class="header-container container-lg">
      ...
      <div class="header-center">
        ...
        <!-- <ul class="header-member">
          ...
          <li class="header-gnbitem"><a class="header-gnblink" href="javascript:void(0)"><span>캠핑안내</span></a></li>
          <li class="header-gnbitem"><a class="header-gnblink" href="javascript:void(0)"><span>스토리</span></a></li>
          <li class="header-gnbitem"><a class="header-gnblink" href="javascript:void(0)"><span>공지사항</span></a></li>
          <li class="header-gnbitem"><a class="header-gnblink" href="javascript:void(0)"><span>FAQ</span></a></li>
          <li class="header-gnbitem"><a class="header-gnblink" href="javascript:void(0)"><span>온라인문의</span></a></li>
        </ul> -->
      </div>
      <div class="header-right">
        <div class="header-utils">
          ...
          <button class="btn-allmenu header-utils-btn">
            <img src="${pageContext.request.contextPath}/assets/icons/ico_menu_white.svg" alt="PC메뉴">
          </button>
