                           ...
                           <input type="hidden" name="url" value="">
                              <div>
                                 ...
                                 <div class="form-group mb-3">
                                    <textarea class="form-control" id="re_content" name="re_content" rows="5" maxlength="1000" placeholder="작성내용은 마이페이지와 장소상세에 노출되며 매장주를 포함한 다른 사용자들이 볼 수 있으니, 서로를 배려하는 마음을 담아 작성해 주세요.">룰루랄라집가자</textarea>
